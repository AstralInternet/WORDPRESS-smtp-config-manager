...
<div class="simple-smtp-dkim-card">
    <h2><?php _e('Email Provider', 'simple-smtp-dkim'); ?></h2>
    <table class="form-table">
        <tr>
            <th scope="row">
                <label for="simple_smtp_dkim_oauth_provider"><?php _e('Provider', 'simple-smtp-dkim'); ?> <abbr title="<?php esc_attr_e('required', 'simple-smtp-dkim'); ?>">*</abbr></label>
            </th>
            <td>
                <select name="simple_smtp_dkim_oauth_provider" id="simple_smtp_dkim_oauth_provider">
                    <option value=""><?php _e('— Select a provider —', 'simple-smtp-dkim'); ?></option>
        ...
        <tr>
            <th scope="row">
                <label for="simple_smtp_dkim_oauth_smtp_address"><?php _e('SMTP / Envelope Address', 'simple-smtp-dkim'); ?> <abbr title="<?php esc_attr_e('required', 'simple-smtp-dkim'); ?>">*</abbr></label>
...
<div class="simple-smtp-dkim-card smtp-oauth-fields">
    <h2><?php _e('Authentication Method', 'simple-smtp-dkim'); ?></h2>
    <table class="form-table">
        <tr>
            <th scope="row">
                <label for="simple_smtp_dkim_oauth_grant_type"><?php _e('Grant Type', 'simple-smtp-dkim'); ?></label>
            ...
            <td>
                <select name="simple_smtp_dkim_oauth_grant_type" id="simple_smtp_dkim_oauth_grant_type">
                    <option value="authorization_code" <?php selected($grant_type, 'authorization_code'); ?>><?php _e('Authorization Code (user consent)', 'simple-smtp-dkim'); ?></option>
                    <option value="client_credentials" <?php selected($grant_type, 'client_credentials'); ?>><?php _e('Client Credentials (app-only / service account)', 'simple-smtp-dkim'); ?></option>
                </select>
            </td>
        </tr>
        <tr>
            <th scope="row">
                <label><?php _e('Credential Type', 'simple-smtp-dkim'); ?></label>
            ...
            <td>
                <fieldset><legend class="screen-reader-text"><?php _e('Credential type', 'simple-smtp-dkim'); ?></legend>
                    <label><input type="radio" name="simple_smtp_dkim_oauth_auth_method" value="secret" <?php checked($auth_method, 'secret'); ?>> <?php _e('Client Secret', 'simple-smtp-dkim'); ?></label><br>
                    <label><input type="radio" name="simple_smtp_dkim_oauth_auth_method" value="certificate" <?php checked($auth_method, 'certificate'); ?>> <?php _e('X.509 Certificate', 'simple-smtp-dkim'); ?></label>
                </fieldset>
            </td>
        </tr>
    </table>
...
<!-- Client Credentials -->
<div class="simple-smtp-dkim-card smtp-oauth-fields">
    <h2><?php _e('Client Credentials', 'simple-smtp-dkim'); ?></h2>
    <table class="form-table">
        <tr>
            <th scope="row"><label for="simple_smtp_dkim_oauth_client_id"><?php _e('Client ID', 'simple-smtp-dkim'); ?> <abbr title="<?php esc_attr_e('required', 'simple-smtp-dkim'); ?>">*</abbr></label></th>
            <td>
        ...
        <tr class="smtp-oauth-secret-field">
            <th scope="row"><label for="simple_smtp_dkim_oauth_client_secret"><?php _e('Client Secret', 'simple-smtp-dkim'); ?> <abbr title="<?php esc_attr_e('required', 'simple-smtp-dkim'); ?>">*</abbr></label></th>
            <td>
                ...
                <?php if ($has_secret): ?>
                <p class="description"><span class="dashicons dashicons-yes-alt" style="color:#00a32a" aria-hidden="true"></span> <?php _e('Saved (encrypted).', 'simple-smtp-dkim'); ?></p>
                <?php endif; ?>
            </td>
        </tr>
        ...
        <tr class="smtp-oauth-cert-field">
            <th scope="row">
                <label for="simple_smtp_dkim_oauth_cert_private_key"><?php _e('Certificate Private Key', 'simple-smtp-dkim'); ?> <abbr title="<?php esc_attr_e('required', 'simple-smtp-dkim'); ?>">*</abbr></label>
        ...
        <tr class="smtp-oauth-cert-field">
            <th scope="row"><label for="simple_smtp_dkim_oauth_cert_thumbprint"><?php _e('Certificate Thumbprint', 'simple-smtp-dkim'); ?> <abbr title="<?php esc_attr_e('required', 'simple-smtp-dkim'); ?>">*</abbr></label></th>
            <td>
...
<div class="simple-smtp-dkim-card smtp-oauth-fields smtp-oauth-authcode-field">
    <h2><?php _e('Refresh Token', 'simple-smtp-dkim'); ?></h2>
    <p><?php _e('Required for authorization_code grant. Obtained during the initial OAuth2 consent flow.', 'simple-smtp-dkim'); ?></p>
    <table class="form-table">
        <tr>
            <th scope="row"><label for="simple_smtp_dkim_oauth_refresh_token"><?php _e('Refresh Token', 'simple-smtp-dkim'); ?> <abbr title="<?php esc_attr_e('required', 'simple-smtp-dkim'); ?>">*</abbr></label></th>
            <td>
...
<div class="simple-smtp-dkim-card smtp-oauth-fields smtp-oauth-microsoft-field">
    <h2><?php _e('Microsoft Settings', 'simple-smtp-dkim'); ?></h2>
    <table class="form-table">
        <tr>
            <th scope="row">
                <label for="simple_smtp_dkim_oauth_tenant"><?php _e('Tenant ID', 'simple-smtp-dkim'); ?> <abbr title="<?php esc_attr_e('required', 'simple-smtp-dkim'); ?>">*</abbr></label>
...
<div class="simple-smtp-dkim-card smtp-oauth-fields smtp-oauth-google-field">
    <h2><?php _e('Google Settings', 'simple-smtp-dkim'); ?></h2>
    <table class="form-table">
        <tr>
            <th scope="row">
                <label for="simple_smtp_dkim_oauth_hosted_domain"><?php _e('Hosted Domain', 'simple-smtp-dkim'); ?></label>
...
<div class="simple-smtp-dkim-card smtp-oauth-fields smtp-oauth-googleapi-field">
    <h2><?php _e('Google API Client Settings', 'simple-smtp-dkim'); ?></h2>
    <table class="form-table">
        <tr>
            <th scope="row">
                <label for="simple_smtp_dkim_oauth_project_id"><?php _e('Project ID', 'simple-smtp-dkim'); ?></label>
        ...
        <tr class="smtp-oauth-svc-field">
            <th scope="row">
                <label for="simple_smtp_dkim_oauth_service_account"><?php _e('Service Account Name', 'simple-smtp-dkim'); ?></label>
        ...
        <tr class="smtp-oauth-svc-field">
            <th scope="row">
                <label for="simple_smtp_dkim_oauth_impersonate"><?php _e('Impersonate (send as)', 'simple-smtp-dkim'); ?></label>
...
<div class="simple-smtp-dkim-card smtp-oauth-fields">
    <details class="smtp-advanced-details">
        <summary><h2 class="smtp-inline-heading"><?php _e('Setup Guide', 'simple-smtp-dkim'); ?></h2></summary>
        <div class="smtp-advanced-inner">
            <div class="smtp-oauth-guide smtp-oauth-guide-microsoft">
                <h3>Microsoft 365 / Outlook</h3>
                <ol>
                    <li><?php _e('Go to <strong>Azure Portal → App registrations → New registration</strong>', 'simple-smtp-dkim'); ?></li>
                    <li><?php _e('Set redirect URI to your site URL', 'simple-smtp-dkim'); ?></li>
                    <li><?php _e('Under <strong>Certificates & secrets</strong>, create a Client Secret or upload a Certificate', 'simple-smtp-dkim'); ?></li>
                    <li><?php _e('Under <strong>API permissions</strong>, add <code>SMTP.Send</code> (delegated) for authorization_code, or <code>Mail.Send</code> (application) for client_credentials', 'simple-smtp-dkim'); ?></li>
                    <li><?php _e('Copy the <strong>Application (client) ID</strong> and <strong>Directory (tenant) ID</strong>', 'simple-smtp-dkim'); ?></li>
                    <li><?php _e('Obtain a Refresh Token using the OAuth2 authorization flow', 'simple-smtp-dkim'); ?></li>
                </ol>
            </div>
            <div class="smtp-oauth-guide smtp-oauth-guide-google">
                <h3>Google / Gmail</h3>
                <ol>
                    <li><?php _e('Go to <strong>Google Cloud Console → APIs & Services → Credentials</strong>', 'simple-smtp-dkim'); ?></li>
                    <li><?php _e('Create an <strong>OAuth 2.0 Client ID</strong> (Web application)', 'simple-smtp-dkim'); ?></li>
                    <li><?php _e('Set redirect URI to your site URL', 'simple-smtp-dkim'); ?></li>
                    <li><?php _e('Enable the <strong>Gmail API</strong> in your project', 'simple-smtp-dkim'); ?></li>
                    <li><?php _e('Copy the <strong>Client ID</strong> and <strong>Client Secret</strong>', 'simple-smtp-dkim'); ?></li>
                    <li><?php _e('For service accounts: enable <strong>domain-wide delegation</strong> in Google Workspace Admin', 'simple-smtp-dkim'); ?></li>
                </ol>
            </div>
        </div>
    </details>
