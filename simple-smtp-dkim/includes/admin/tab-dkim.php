...
<div class="simple-smtp-dkim-section">
    ...
    <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" class="simple-smtp-dkim-form" enctype="multipart/form-data">
        ...
        <div class="simple-smtp-dkim-card">
            <h2><?php _e('DKIM Settings', 'simple-smtp-dkim'); ?></h2>
            <table class="form-table">
                <tr>
                    <th scope="row">
                        <label for="simple_smtp_dkim_dkim_enabled"><?php _e('Enable DKIM Signing', 'simple-smtp-dkim'); ?></label>
                    ...
                    <td>
                        ...
                        <?php if ($enabled && !$dns_verified): ?>
                            <p class="description" style="color:#d63638; margin-top:8px;">
                                ...
                                <?php _e('DKIM is enabled but <strong>not signing emails</strong> yet. Complete the DNS validation below to activate signing.', 'simple-smtp-dkim'); ?>
                            </p>
                        <?php elseif ($enabled && $dns_verified): ?>
                            <p class="description" style="color:#00a32a; margin-top:8px;">
                                ...
                                <?php _e('DKIM is <strong>active</strong> — outgoing emails are being signed.', 'simple-smtp-dkim'); ?>
                            </p>
                        <?php endif; ?>
                    </td>
                </tr>
                <tr class="smtp-dkim-field">
                    <th scope="row"><label for="simple_smtp_dkim_dkim_domain"><?php _e('Domain', 'simple-smtp-dkim'); ?> <abbr title="<?php esc_attr_e('required', 'simple-smtp-dkim'); ?>">*</abbr></label></th>
                ...
                <tr class="smtp-dkim-field">
                    <th scope="row">
                        <label for="simple_smtp_dkim_dkim_selector"><?php _e('Selector', 'simple-smtp-dkim'); ?> <abbr title="<?php esc_attr_e('required', 'simple-smtp-dkim'); ?>">*</abbr></label>
        ...
        <div class="simple-smtp-dkim-card smtp-dkim-field">
            <h2><?php _e('Generate DKIM Keys', 'simple-smtp-dkim'); ?></h2>
            <p><?php _e('Generate a key pair automatically. You will then need to add the DNS record at your domain registrar.', 'simple-smtp-dkim'); ?></p>

            <div id="smtp-dkim-generate-section">
                <button type="button" id="smtp-generate-dkim-keys" class="button button-primary">
                    <span class="dashicons dashicons-admin-network" aria-hidden="true"></span>
                    <?php _e('Generate DKIM Keys', 'simple-smtp-dkim'); ?>
                </button>
                ...
                <button type="button" id="smtp-view-dkim-keys" class="button button-secondary" style="margin-left:8px;">
                    ...
                    <?php _e('View Saved DNS Record', 'simple-smtp-dkim'); ?>
                </button>
                <p class="description" style="margin-top:8px;color:#00a32a;">
                    <span class="dashicons dashicons-yes-alt" aria-hidden="true"></span>
                    <?php _e('Keys generated. Click "View Saved DNS Record" to see the value.', 'simple-smtp-dkim'); ?>
                </p>
                <?php endif; ?>
            </div>
            ...
            <div id="smtp-dkim-generated-result" class="smtp-dkim-dns-block" style="display:none;" role="region" aria-label="<?php esc_attr_e('DNS Record', 'simple-smtp-dkim'); ?>">
                <h3 id="smtp-dkim-result-title"><?php _e('Copy this DNS record and add it at your registrar:', 'simple-smtp-dkim'); ?></h3>
                <table class="smtp-dns-table">
                    <tr>
                        <th scope="row"><?php _e('Name', 'simple-smtp-dkim'); ?></th>
                        <td>
                            <code id="smtp-dns-record-name"></code>
                            <button type="button" class="button button-small smtp-copy-btn" data-copy-target="smtp-dns-record-name" aria-label="<?php esc_attr_e('Copy DNS record name', 'simple-smtp-dkim'); ?>"><?php _e('Copy', 'simple-smtp-dkim'); ?></button>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row"><?php _e('Type', 'simple-smtp-dkim'); ?></th>
                        <td><code>TXT</code></td>
                    </tr>
                    <tr>
                        <th scope="row"><?php _e('Value', 'simple-smtp-dkim'); ?></th>
                        <td>
                            ...
                            <button type="button" class="button button-small smtp-copy-btn" data-copy-target="smtp-dns-record-value" aria-label="<?php esc_attr_e('Copy DNS record value', 'simple-smtp-dkim'); ?>"><?php _e('Copy', 'simple-smtp-dkim'); ?></button>
                        </td>
                    </tr>
                </table>
                <div class="smtp-success-notice">
                    <span class="dashicons dashicons-yes-alt" aria-hidden="true"></span>
                    <?php _e('Private key saved automatically. Add the DNS record above, then save and validate.', 'simple-smtp-dkim'); ?>
                </div>
                <button type="button" id="smtp-close-dkim-display" class="button" style="margin-top:10px;"><?php _e('Close', 'simple-smtp-dkim'); ?></button>
            </div>
        ...
        <!-- 3. Validate -->
        <div class="simple-smtp-dkim-card smtp-dkim-field">
            <h2><?php _e('Validate Configuration', 'simple-smtp-dkim'); ?></h2>
            <p><?php _e('Check that your private key is valid and the DNS record is correctly set.', 'simple-smtp-dkim'); ?></p>
            <button type="button" id="smtp-validate-dkim" class="button button-secondary">
                <span class="dashicons dashicons-shield-alt" aria-hidden="true"></span> <?php _e('Validate DKIM', 'simple-smtp-dkim'); ?>
            </button>
        ...
        <div class="simple-smtp-dkim-card smtp-dkim-field">
            <details class="smtp-advanced-details">
                <summary>
                    <h2 class="smtp-inline-heading"><?php _e('Advanced / Manual Configuration', 'simple-smtp-dkim'); ?></h2>
                </summary>

                <div class="smtp-advanced-inner">
                    <p class="description"><?php _e('Use this section if you prefer to manage DKIM keys manually (e.g., generated externally).', 'simple-smtp-dkim'); ?></p>

                    <!-- Passphrase -->
                    <table class="form-table">
                        <tr>
                            <th scope="row"><label for="simple_smtp_dkim_dkim_passphrase"><?php _e('Key Passphrase', 'simple-smtp-dkim'); ?></label></th>
                            <td>
                                ...
                                <p class="description"><span class="dashicons dashicons-yes-alt" style="color:#00a32a" aria-hidden="true"></span> <?php _e('Passphrase saved.', 'simple-smtp-dkim'); ?></p>
                                <?php endif; ?>
                            </td>
                        </tr>
                    </table>
                    ...
                    <!-- Storage Method -->
                    <h3><?php _e('Private Key Storage', 'simple-smtp-dkim'); ?></h3>
                    <table class="form-table"><tr>
                        <th scope="row"><?php _e('Method', 'simple-smtp-dkim'); ?></th>
                        <td>
                            <fieldset><legend class="screen-reader-text"><?php _e('Storage method', 'simple-smtp-dkim'); ?></legend>
                            <label><input type="radio" name="simple_smtp_dkim_dkim_storage_method" value="database" <?php checked($storage_method, 'database'); ?>> <?php _e('Database (encrypted)', 'simple-smtp-dkim'); ?></label><br>
                            <label><input type="radio" name="simple_smtp_dkim_dkim_storage_method" value="file" <?php checked($storage_method, 'file'); ?>> <?php _e('File on server', 'simple-smtp-dkim'); ?></label>
                            </fieldset>
                        </td>
                    </tr></table>
                    ...
                    <div class="smtp-storage-option smtp-storage-database" style="<?php echo esc_attr($storage_method === 'database' ? '' : 'display:none;'); ?>">
                        <table class="form-table"><tr>
                            <th scope="row"><label for="simple_smtp_dkim_dkim_upload"><?php _e('Upload Private Key', 'simple-smtp-dkim'); ?></label></th>
                            <td>
                                ...
                                <p class="description"><span class="dashicons dashicons-yes-alt" style="color:#00a32a" aria-hidden="true"></span> <?php _e('Key stored (encrypted).', 'simple-smtp-dkim'); ?></p>
                                <?php endif; ?>
                            </td>
                        </tr></table>
                    </div>
                    ...
                    <div class="smtp-storage-option smtp-storage-file" style="<?php echo esc_attr($storage_method === 'file' ? '' : 'display:none;'); ?>">
                        <table class="form-table"><tr>
                            <th scope="row"><label for="simple_smtp_dkim_dkim_file_path"><?php _e('File Path', 'simple-smtp-dkim'); ?></label></th>
                            <td>
                                ...
                                <p class="description"><?php _e('Or upload:', 'simple-smtp-dkim'); ?></p>
                                ...
                                <p class="description"><span class="dashicons dashicons-yes-alt" style="color:#00a32a" aria-hidden="true"></span> <?php printf(__('File readable: %s', 'simple-smtp-dkim'), esc_html($file_path)); ?></p>
                                <?php elseif (!empty($file_path)): ?>
                                <p class="description" style="color:#d63638;"><span class="dashicons dashicons-warning" aria-hidden="true"></span> <?php printf(__('File not found: %s', 'simple-smtp-dkim'), esc_html($file_path)); ?></p>
                                <?php endif; ?>
                            </td>
                        </tr></table>
                    </div>
                    ...
                    <details class="smtp-advanced-details" style="margin-top:15px;">
                        <summary><?php _e('How to generate keys manually (OpenSSL)', 'simple-smtp-dkim'); ?></summary>
                        <div class="smtp-code-block" style="margin-top:10px;">
                            <code>
                                # <?php _e('Generate private key', 'simple-smtp-dkim'); ?><br>
                                openssl genrsa -out dkim.private 2048<br><br>
                                # <?php _e('Extract public key', 'simple-smtp-dkim'); ?><br>
        ...
        <p class="submit">
            <button type="submit" class="button button-primary button-large"><?php _e('Save DKIM Settings', 'simple-smtp-dkim'); ?></button>
        </p>
    </form>
</div>
