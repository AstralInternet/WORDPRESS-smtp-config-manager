...
<div class="simple-smtp-dkim-section">
    <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" class="simple-smtp-dkim-form">
        ...
        <div class="simple-smtp-dkim-card">
            <h2><?php _e('Debug Mode', 'simple-smtp-dkim'); ?></h2>
            <table class="form-table">
                <tr>
                    <th scope="row">
                        <label for="simple_smtp_dkim_debug_mode"><?php _e('Enable Debug Logging', 'simple-smtp-dkim'); ?></label>
        ...
        <!-- Uninstall Behaviour -->
        <div class="simple-smtp-dkim-card">
            <h2><?php _e('Uninstall Behaviour', 'simple-smtp-dkim'); ?></h2>
            <table class="form-table">
                <tr>
                    <th scope="row">
                        <label for="simple_smtp_dkim_delete_on_uninstall"><?php _e('Delete All Data on Uninstall', 'simple-smtp-dkim'); ?></label>
                    ...
                    <td>
                        ...
                        <p class="description" style="color:#d63638;">
                            <strong><?php _e('Warning:', 'simple-smtp-dkim'); ?></strong>
                            <?php _e('All email logs, DKIM keys, settings and configuration will be permanently deleted.', 'simple-smtp-dkim'); ?>
                        </p>
                    </td>
                </tr>
            </table>
        ...
        <!-- Encryption Status -->
        <div class="simple-smtp-dkim-card">
            <h2><?php _e('Encryption Status', 'simple-smtp-dkim'); ?></h2>
            <?php $enc = Simple_SMTP_DKIM_Encryption::get_encryption_info(); ?>
            <table class="smtp-summary-table">
                <tr>
                    <th><?php _e('OpenSSL', 'simple-smtp-dkim'); ?></th>
                    <td>
                        <?php if ($enc['available']): ?>
                            <span style="color:#00a32a;">&#10003; <?php _e('Available', 'simple-smtp-dkim'); ?></span>
                        <?php else: ?>
                            <span style="color:#d63638;">&#10007; <?php _e('Not available', 'simple-smtp-dkim'); ?></span>
                        <?php endif; ?>
                    </td>
                </tr>
                <tr>
                    <th><?php _e('Cipher', 'simple-smtp-dkim'); ?></th>
                    <td><code><?php echo esc_html($enc['method']); ?></code></td>
                </tr>
                <tr>
                    <th><?php _e('Key Location', 'simple-smtp-dkim'); ?></th>
                    <td>
                        <?php if (!defined('SIMPLE_SMTP_DKIM_KEY_IN_DB') || !SIMPLE_SMTP_DKIM_KEY_IN_DB): ?>
                            <span style="color:#00a32a;">&#10003; <?php _e('wp-config.php (secure)', 'simple-smtp-dkim'); ?></span>
                        <?php else: ?>
                            <span style="color:#d63638;">&#10007; <?php _e('Database — see admin notice above to migrate to wp-config.php', 'simple-smtp-dkim'); ?></span>
                        <?php endif; ?>
                    </td>
                </tr>
            </table>
        ...
        <p class="submit">
            <button type="submit" class="button button-primary button-large"><?php _e('Save Advanced Settings', 'simple-smtp-dkim'); ?></button>
        </p>
    </form>
</div>
