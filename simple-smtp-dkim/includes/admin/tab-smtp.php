...
<div class="simple-smtp-dkim-section">
    ...
    <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" class="simple-smtp-dkim-form" id="smtp-settings-form" novalidate>
        ...
        <div class="simple-smtp-dkim-card">
            <h2><?php _e('Enable SMTP', 'simple-smtp-dkim'); ?></h2>
            <table class="form-table"><tr>
                <th scope="row">
                    <label for="simple_smtp_dkim_enabled"><?php _e('Enable SMTP', 'simple-smtp-dkim'); ?></label>
        ...
        <p class="submit">
            <button type="submit" class="button button-primary button-large"><?php _e('Save SMTP Settings', 'simple-smtp-dkim'); ?></button>
        </p>
    </form>
</div>
